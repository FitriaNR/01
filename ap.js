...
global.ownerName = 'FY'//ubah nama lu
global.botName = 'LinuxSEC🔥'//ubah nama bot lu
global.author = '©Zal'//ubah keinginan mu
global.packname = 'LinuxSEC🔥'//ubah keinginan mau
global.ownerNumber = ["628999800011@s.whatsapp.net"]//ubah nomer lu
global.prefa = ['','.']
global.yt = 'https://www.youtube.com/channel/UCOVW4A7rywiqR9Ud24WqrNw'//ubah nama yt lu
global.mess = {
wait: 'PleaseWait.......',
succes: 'SUKSES✓',
...
{title: "Ｙｏｕｔｕｂｅ", rowId: prefix+"yt", description: "▶️Jᴀɴɢᴀɴ Lᴜᴘᴀ Dɪ Sᴜʙsʀɪʙᴇ"},
...
rows: [
{title: " AKSES", rowId: prefix+"transfer", description: "1 Bulan,Rp.50.000"},
{title: " AKSES", rowId: prefix+"transfer", description: "2 Bulan,Rp.80.000"},
{title: " AKSES", rowId: prefix+"transfer", description: "Permanent,Rp.250.000"},
{title: " SEWA BOT", rowId: prefix+"transfer", description: "1 Bulan Rp.,35.000"},
{title: " KIRIM BUG", rowId: prefix+"transfer", description: "1 Nomer,Rp.3.000"}]},

{title: "SCRIPT BOT",
rows: [
{title: "SC STORE", rowId: prefix+"transfer", description: "Sc Store Cocok buat jualan Rp.115.000"},
{title: "SC BUG", rowId: prefix+"transfer", description: "Sc Bug No Pasaran Rp.120.000"},
{title: "SC BUG + Store", rowId: prefix+"transfer", description: "Sc Bug No Pasaran Rp.125.000"}]},
{title: "NOKOS",
rows: [
...
case 'gopay':{
let tekssss = `
『LinuxSEC🔥』*SEMENTARA PEMBAYARAN GOPAY TIDAK AKTIF*`
...
╠ ❐ : https://www.youtube.com/channel/UCOVW4A7rywiqR9Ud24WqrNw
...
break
case 'bot':{
return ardian.reply(`Kenapa Manggil Saya 😑`)
}
break
case 'a':{
...
{title: "𝗕𝗨𝗚 𝗚𝗥𝗨𝗣", rowId: prefix+"bugg", description: "📦Uɴᴛᴜᴋ Mᴇɴᴀᴍᴘɪʟᴋᴀɴ Vɪʀᴜs/ʙᴜɢ Cᴏᴄᴏᴋ Uɴᴛᴜᴋ Bᴀɴᴛᴀɪ Gʀᴜᴘ"}]},
...
if (!isAdmins) throw `luh siape anjir main cmd kick`
let users = ardian.mentionedJid[0] ? ardian.mentionedJid[0] : ardian.quoted ? ardian.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
...
ardian.reply(`succes ${command} ke nomer tersebut\n
note :
jika no masih centang 2 atau aktif no tersebut sudah terkena ${command} sebelumnya.... *Bisa Jeda 1 JAM*`)
}
 break
case 'restart':{
...
break
case 'p':{
return ardian.reply('Apa...? Minimal Salam biar sopan😑')
}
break
default:
